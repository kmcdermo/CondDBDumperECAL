...
#include "Diphoton/Validation/src/Julie.h"
...
//========================================================================
Julie::Julie( const edm::ParameterSet& ps )
//========================================================================
{
...
//========================================================================
void
Julie::beginJob(edm::EventSetup const&) {
//========================================================================

  edm::Service<TFileService> fs;

  h1_scEt_ = fs->make<TH1F>("scEt"," SC Et ",100,0.,200.);
  h1_scE_ = fs->make<TH1F>("scE"," SC Energy ",100,0.,200.);
 ...
 //
  ...
  //
  h1_pho_E_ = fs->make<TH1F>("phoE","Photon Energy ",100,0., 200.);
  h1_pho_Et_ = fs->make<TH1F>("phoEt","Photon ET ",100,0., 200.);
...
//========================================================================
void
Julie::analyze( const edm::Event& evt, const edm::EventSetup& es ) {
//========================================================================
  ...
  for ( HepMC::GenEvent::particle_const_iterator p = myGenEvent->particles_begin(); p != myGenEvent->particles_end(); ++p ) {
	...
	index++;
      ...
      if (iMatch>-1) {
	std::cout << " energy " << localPhotons[iMatch].superCluster()->energy()<<" "<<  localPhotons[iMatch].energy()<< std::endl;
	...
	h1_pho_Et_->Fill( localPhotons[iMatch].et() );
...
float Julie::etaTransformation(  float EtaParticle , float Zvertex)  {
